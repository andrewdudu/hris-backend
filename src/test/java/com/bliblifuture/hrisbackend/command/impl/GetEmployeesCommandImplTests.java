...
public class GetEmployeesCommandImplTests {
    ...
    @Test
    public void testWithDepartmentAndKeywordPaging_execute() throws ParseException {
        String depId = "DEP-1";
        String name = "a";
        int page = 0;
        int size = 10;
    ...
    @Test
    public void testWithOnlyKeywordPaging_execute() throws ParseException {
        String depId = "DEP-1";
        String name = "a";
        int page = 0;
        int size = 10;
        ...
        Mockito.verify(employeeElasticsearchRepository, Mockito.times(1)).search("*a*");
        Mockito.verify(employeeRepository, Mockito.times(1)).findById(employeeIndex1.getId());
        Mockito.verify(employeeRepository, Mockito.times(1)).findById(employeeIndex2.getId());
        Mockito.verify(officeRepository, Mockito.times(2)).findById(office.getId());
        Mockito.verify(departmentRepository, Mockito.times(2)).findById(depId);
    ...
    @Test
    public void testWithDepartmentPaging_execute() throws ParseException {
        String depId = "DEP-1";
        int page = 0;
        int size = 10;
        EmployeesRequest request = new EmployeesRequest();
        ...
        Mockito.when(employeeRepository.findByDepId(department.getId()))
        ...
        Mockito.verify(departmentRepository, Mockito.times(1)).findFirstByCode(request.getDepartment());
        Mockito.verify(employeeRepository, Mockito.times(1)).findByDepId(department.getId());
        Mockito.verify(officeRepository, Mockito.times(2)).findById(office.getId());
        Mockito.verify(departmentRepository, Mockito.times(2)).findById(depId);
    ...
    @Test
    public void testWithOnlyPaging_execute() throws ParseException {
        int page = 0;
        int size = 10;
        EmployeesRequest request = new EmployeesRequest();
        request.setPage(page);
        ...
        Department department = Department.builder()
                ...
                .code("DEP-1")
                .build();
        department.setId(employee1.getDepId());
        ...
        Mockito.verify(departmentRepository, Mockito.times(2)).findById(employee1.getDepId());
