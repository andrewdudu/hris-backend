...
public class GetIncomingRequestCommandImpl implements GetIncomingRequestCommand {
    ...
    public Mono<List<RequestResponse>> execute(String type) {
        return leaveRequestRepository.findByStatusOrderByCreatedDateDesc(RequestStatus.valueOf(type))
                .flatMap(this::createResponse)
                .collectList();
    }

    private Mono<RequestResponse> createResponse(Request request) {
